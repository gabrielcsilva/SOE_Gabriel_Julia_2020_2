# -*- coding: utf-8 -*-
"""
Created on Sat Mar 20 14:56:29 2021

@author: Gabriel Coelho e Julia Borges
"""
...
while True:
    ...
    dilatada = cv2.morphologyEx(dilat, cv2.MORPH_OPEN, (2,2))
    dilatada= cv2.dilate(dilatada,(9,9),2)
    dilatada = cv2.morphologyEx(dilatada, cv2.MORPH_CLOSE, kernel)  # Tenta preencher todos os "buracos" da imagem
